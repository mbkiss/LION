...
final_result_fname = savefolder.joinpath("LPD_Sparse90.pt")
checkpoint_fname = "LPD_Sparse90_check_*.pt"  # if you use LION checkpoiting, remember to have wildcard (*) in the filename
validation_fname = savefolder.joinpath("LPD_Sparse90_min_val.pt")
...
plt.savefig("loss_LPD_Sparse90..png")
