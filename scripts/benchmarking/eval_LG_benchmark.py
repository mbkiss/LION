...
plt.savefig("LG_Limited90_eval_best_psnr.png", dpi=300)
...
plt.savefig("LG_Limited90_eval_worst_psnr.png", dpi=300)
del target, data, recon, output
...
plt.savefig("LG_Limited90_eval_mean_psnr.png", dpi=300)
