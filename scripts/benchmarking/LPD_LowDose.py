...
final_result_fname = savefolder.joinpath("LPD_LowDose.pt")
checkpoint_fname = "LPD_LowDose_check_*.pt"  # if you use LION checkpoiting, remember to have wildcard (*) in the filename
validation_fname = savefolder.joinpath("LPD_LowDose_min_val.pt")
...
plt.savefig("loss_LPD_LowDose.png")
