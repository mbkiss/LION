...
plt.savefig("LPD_LowDose_eval_best_psnr.png", dpi=300)
...
plt.savefig("LPD_LowDose_eval_worst_psnr.png", dpi=300)
del target, data, recon, output
...
plt.savefig("LPD_LowDose_eval_mean_psnr.png", dpi=300)
