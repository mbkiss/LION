...
final_result_fname = savefolder.joinpath("LPD_Limited150.pt")
checkpoint_fname = "LPD_Limited150_check_*.pt"  # if you use LION checkpoiting, remember to have wildcard (*) in the filename
validation_fname = savefolder.joinpath("LPD_Limited150_min_val.pt")
...
plt.savefig("loss_LPD_Limited150.png")
