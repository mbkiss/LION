...
model_name = "FBPUNet_Sparse720.pt"
...
plt.savefig("FBPUNet_Sparse720_eval_best_psnr.png", dpi=300)
...
plt.savefig("FBPUNet_Sparse720_eval_worst_psnr.png", dpi=300)
del target, data, recon, output
...
plt.savefig("FBPUNet_Sparse720_eval_mean_psnr.png", dpi=300)
