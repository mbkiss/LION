...
final_result_fname = savefolder.joinpath("FBPMSDNet_Sparse720.pt")
checkpoint_fname = "FBPMSDnet_Sparse720_check_*.pt"  # if you use LION checkpoiting, remember to have wildcard (*) in the filename
validation_fname = savefolder.joinpath("FBPMSDnet_Sparse720_min_val.pt")
...
plt.savefig("loss_FBPMSDNet_Sparse720.png")
