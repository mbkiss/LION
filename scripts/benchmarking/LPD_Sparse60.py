...
final_result_fname = savefolder.joinpath("LPD_Sparse60.pt")
checkpoint_fname = "LPD_Sparse60_check_*.pt"  # if you use LION checkpoiting, remember to have wildcard (*) in the filename
validation_fname = savefolder.joinpath("LPD_Sparse60_min_val.pt")
...
plt.savefig("loss_LPD_Sparse60..png")
