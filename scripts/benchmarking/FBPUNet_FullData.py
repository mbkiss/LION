...
final_result_fname = savefolder.joinpath("FBPUNet_FullData.pt")
checkpoint_fname = "FBPUnet_FullData_check_*.pt"  # if you use LION checkpoiting, remember to have wildcard (*) in the filename
validation_fname = savefolder.joinpath("FBPUnet_FullData_min_val.pt")
...
plt.savefig("loss_FBPUNet_FullData.png")
