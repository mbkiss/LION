...
final_result_fname = savefolder.joinpath("ISTANet_FullData.pt")
checkpoint_fname = "ISTANet_FullData_check_*.pt"  # if you use LION checkpoiting, remember to have wildcard (*) in the filename
validation_fname = savefolder.joinpath("ISTANet_FullData_min_val.pt")
...
from LION.models.iterative_unrolled.ISTANet import ISTANet

# If you are happy with the default parameters, you can just do
model = ISTANet(experiment.geo).to(device)
...
plt.savefig("loss_ISTANet_FullData.png")
