...
#experiment = ct_benchmarking.ArtificialNoiseDenoising()
...
model = MS_D(experiment.geo).to(device)
...
default_parameters = MS_D.default_parameters(mode="regression")
...
model = MS_D(experiment.geo, default_parameters).to(device)
